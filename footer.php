...
<footer id="colophon" class="site-footer bg-blue-dark py-4">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <ul>
                    ...
                    <li><a href="#" class="uppercase color-white">FAQ</a></li>
                </ul>
            </div>
            <div class="col-md-3">
                <ul>
                    ...
                    <li><a href="#" class="uppercase color-white">Engagement</a></li>
                </ul>
            </div>
            <div class="col-md-3">
                <ul>
                    ...
                    <li><a href="#" class="uppercase color-white">Espace particulier</a></li>
                    <li><a href="#" class="uppercase color-white">Comment créer
                            un compte</a></li>
                </ul>
            </div>
            <div class="col-md-3">
                <ul>
                    ...
                    <li><a href="#" class="uppercase color-white">Nos partenaires</a></li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <a href="#" class="color-white">Mentions légales</a>
                <a href="#" class="color-white">CGV-CGU</a>
            </div>
        </div>
    </div>
</footer><!-- #colophon -->
